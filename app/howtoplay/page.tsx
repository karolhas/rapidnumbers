...
export default function HowToPlay() {
   ...
   const handleBackToMenu = (e: { preventDefault: () => void }) => {
      e.preventDefault();
      router.push("/");
   };
            ...
            <div className="w-[80%] sm:w-[50%] text-[18px] leading-[36px]">
               ...
               <ol className="list-decimal">
                  ...
                  <li className="my-3">
                     ...
                     {""} zawierająca liczby 1-100 (ta opcja jest dostępna tylko
                     na PC oraz tabletach).
                  </li>
                  <li>
                     ...
                     - po każdym kliknięciu w liczbę tablica na nowo się
                     przetasowuje.
                  </li>
                  <li className="my-4">
                     Gra polega na jak najszybszym klikaniu w liczby od
                     najmniejszej do największej i zdobyciu najwyższego miejsca
                     w rankingu.
                  </li>
               </ol>
            </div>
